...
```bash
cat /tmp/supercomm/translation_packages/10_lw_expr_parse_term/source.c
cat /tmp/supercomm/translation_packages/10_lw_expr_parse_term/checklist.md
cat /tmp/supercomm/translation_packages/10_lw_expr_parse_term/existing.py
