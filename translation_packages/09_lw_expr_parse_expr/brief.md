# Translation Brief: `lw_expr_parse_expr`

## Your task

Produce a faithful Python translation of the C function `lw_expr_parse_expr`.
...
```bash
cat /tmp/supercomm/translation_packages/09_lw_expr_parse_expr/source.c
cat /tmp/supercomm/translation_packages/09_lw_expr_parse_expr/checklist.md
cat /tmp/supercomm/translation_packages/09_lw_expr_parse_expr/existing.py
...
cat /tmp/supercomm/cocotools/lw_expr.py
```
...
1. `translation_packages/09_lw_expr_parse_expr/source.c` -- THE SPEC. THE TRUTH.
2. `translation_packages/09_lw_expr_parse_expr/checklist.md` -- pre-filled risk analysis
...
6. `translation_packages/09_lw_expr_parse_expr/existing.py` -- current translation (SUSPECT)
...
Package all of the above into a zip file named `lw_expr_parse_expr_audit.zip`
and present it for download. This zip will be placed in the
`translation_packages/09_lw_expr_parse_expr/` directory for review.
