...
```bash
cat /tmp/supercomm/translation_packages/14_insn_emit_bitbit/source.c
cat /tmp/supercomm/translation_packages/14_insn_emit_bitbit/checklist.md
cat /tmp/supercomm/translation_packages/14_insn_emit_bitbit/existing.py
...
1. `translation_packages/14_insn_emit_bitbit/source.c` -- THE SPEC. THE TRUTH.
2. `translation_packages/14_insn_emit_bitbit/checklist.md` -- pre-filled risk analysis
...
6. `translation_packages/14_insn_emit_bitbit/existing.py` -- current translation (SUSPECT)
