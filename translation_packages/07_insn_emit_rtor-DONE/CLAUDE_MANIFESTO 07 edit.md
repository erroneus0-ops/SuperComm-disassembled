...
# Last updated: July 17 2026 (session: restored "push back on Daniel's ideas"
#   directive, which was present in an earlier version and dropped out across
#   later refinements without being noticed -- see Claude Behavior Directives)
# Previous update: July 15 2026 (session: XRoar debug exports, cocotools PSHS D fix,
