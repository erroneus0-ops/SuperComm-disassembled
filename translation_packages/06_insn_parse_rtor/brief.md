# Translation Brief: `insn_parse_rtor`

## Your task

Produce a faithful Python translation of the C function `insn_parse_rtor`.
...
C source: `lwtools-4.24/lwasm/insn_rtor.c`
Python target: `cocotools/insn_funcs.py`
Size: 32 lines, 2 branches, 0 gotos
...
```bash
cat /tmp/supercomm/translation_packages/06_insn_parse_rtor/source.c
cat /tmp/supercomm/translation_packages/06_insn_parse_rtor/checklist.md
cat /tmp/supercomm/translation_packages/06_insn_parse_rtor/existing.py
...
1. `translation_packages/06_insn_parse_rtor/source.c` -- THE SPEC. THE TRUTH.
2. `translation_packages/06_insn_parse_rtor/checklist.md` -- pre-filled risk analysis
...
6. `translation_packages/06_insn_parse_rtor/existing.py` -- current translation (SUSPECT)
...
Package all of the above into a zip file named `insn_parse_rtor_audit.zip`
and present it for download. This zip will be placed in the
`translation_packages/06_insn_parse_rtor/` directory for review.

## Reference

C source (from repo tarball): https://raw.githubusercontent.com/erroneus0-ops/SuperComm-disassembled/main/lwtools-4.24/lwasm/insn_rtor.c
...
source.c: https://raw.githubusercontent.com/erroneus0-ops/SuperComm-disassembled/main/translation_packages/06_insn_parse_rtor/source.c
checklist.md: https://raw.githubusercontent.com/erroneus0-ops/SuperComm-disassembled/main/translation_packages/06_insn_parse_rtor/checklist.md
existing.py: https://raw.githubusercontent.com/erroneus0-ops/SuperComm-disassembled/main/translation_packages/06_insn_parse_rtor/existing.py
