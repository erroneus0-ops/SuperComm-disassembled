#!/usr/bin/env python3
"""
dis6x09.py — OS-9 6809 Disassembler Engine
======================================================
...
Usage:
    from dis6x09 import Engine, Project
    ...
    if args.proj:
        ...
        if not os.path.exists(json_path):
            ...
            if proj.binary_crc is None:
                ...
                print()
                print(f"    python dis6x09.py --source {source} --proj {new_name}")
                print()
                sys.exit(0)
        ...
        if os.path.exists(inferred):
            ...
            print()
            print(f"    python dis6x09.py --source {source} --proj {inferred}")
            print()
            sys.exit(1)
